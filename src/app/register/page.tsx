        ...
        {registerSuccess ? (
          <div className='space-y-5'>
            ...
            <button
              ...
              className='inline-flex w-full justify-center rounded-lg bg-[color:var(--brand)] py-3 text-base font-semibold text-white shadow-lg transition-all duration-200 hover:brightness-110'
            >
              前往登录
            </button>
          </div>
